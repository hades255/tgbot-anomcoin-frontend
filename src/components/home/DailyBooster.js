  ...
  return (
    <>
      <div
        ...
        className={clsx(
          "z-10 absolute bottom-0 right-0 w-8 h-8 rounded-full border border-white hover:bg-blue-600 transition-all flex justify-center items-center cursor-pointer text-shadow-expire-item"
        )}
      >
        🚀
      </div>
